...
A forensic network-analysis exercise reconstructing a real-world information-stealer infection from a single packet capture (`pcap/hawkeye.pcap`), documented through independent Red Team, Blue Team, and Purple Team reports.
